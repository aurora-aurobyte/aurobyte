                        ...
                        <div className="col-12">
                            <div className="section-title">
                                ...
                                <p
                                    ...
                                    data-wow-delay=".6s"
                                >
                                    Join the Aurora family and become a vital
                                    member of a team of digital product
                                    specialists with a global reputation.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <div className="single-table">
                                ...
                                <div className="table-head">
                                    ...
                                    <p className="sub-title">Remote</p>
                                </div>
                                {/* End Table Head */}
                                {/* Start Table Content */}
